...
* [사용료 및 포인트 결제](get-started/monthly.md)
* [스마트콜 서비스 신청하기](get-started/smartcall.md)
...
* [문자 기능](basic-features/message/README.md)
  * [발신 번호 인증하기](basic-features/message/pre-registration.md)
...
* [문자결제 사용하기](payments/sms/README.md)
  * [🆕 올톡페이](payments/sms/alltalkpay/README.md)
    * [올톡페이 가입하기](payments/sms/alltalkpay/signup.md)
    * [결제 알림톡 발송](payments/sms/alltalkpay/send.md)
    * [청구서 파기와 결제 취소](payments/sms/alltalkpay/cancel.md)
    * [올톡페이 매니저 사이트](payments/sms/alltalkpay/manager.md)
  * [결제선생](payments/sms/payssam/README.md)
    * [결제선생 가입하기](payments/sms/payssam/signup.md)
    * [결제 알림톡 발송](payments/sms/payssam/send.md)
    * [청구서 파기와 결제 취소](payments/sms/payssam/cancel.md)
    * [자동결제 관리](payments/sms/payssam/auto.md)
    * [결제선생 매니저 사이트](payments/sms/payssam/manager.md)
* [청구 및 수납 현황 조회](payments/lookup/README.md)
  ...
  * [영수증 일괄 인쇄](payments/lookup/receipt_print.md)
...
* [출결 관리](class/attendance/README.md)
  * [스마트 출결기](class/attendance/smart.md)
  * [출석 결과 기록하기](class/attendance/input.md)
  * [출결 통계 조회](class/attendance/stats.md)
  * [실시간 출결 모니터링](class/attendance/undefined.md)
* [수업 결과 관리](class/results/README.md)
  * [수업 결과 기록](class/results/record.md)
  * [출결 문자 발송](class/results/send-attendance.md)
  * [수업 결과 문자 전송](class/results/send-class.md)
...
* [시험 추가와 관리](test/add-test/README.md)
  ...
  * [시험별 성적표 커스텀](test/add-test/custom.md)
...
* [홈페이지 세부 설정하기](homepage/settings/README.md)
  ...
  * [메뉴 설정](homepage/settings/menu.md)
  * [인트로 카드 영역 설정](homepage/settings/intro.md)
...
* [설명회 모집](utilizing-homepage/presentation/README.md)
  * [설명회 신청 시 직원의 문자 수신 설정](utilizing-homepage/presentation/receive-message.md)
  * [알림 문자 설정](utilizing-homepage/presentation/set-message.md)
* [온라인 강의](utilizing-homepage/online-lecture.md)

## 🎸 기타 기능 <a href="#miscellaneous" id="miscellaneous"></a>

* [🆕 교재주문중계 사용하기](miscellaneous/allbooks.md)
* [맥가이 설문 기능](miscellaneous/form/README.md)
  * [설문지 제작과 수정](miscellaneous/form/adding.md)
  * [설문지 공유하기](miscellaneous/form/share.md)
  * [설문지 결과 확인하기](miscellaneous/form/result.md)
* [도서 대여 기능](miscellaneous/book.md)
* [업무일지 기능](miscellaneous/work-log.md)
