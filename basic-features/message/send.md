...
[**채널톡 바로가기↗**](https://docs.channel.io/macgai-guide/ko/articles/send-sms-2304bdda)
{% endhint %}
...
왼쪽 사이드 메뉴의 \[**문자 보내기**] 메뉴에서 문자를 보낼 수 있어요.
...
1. 보낼 내용을 작성합니다. 내용이 80 byte (한글 40자)가 넘어가면 LMS로 자동 변경됩니다.
   * LMS 발송 시 제목을 작성할 수 있습니다. (제목을 작성하지 않으면 본문 첫 25\~30자가 자동으로 제목에 노출됩니다.)
